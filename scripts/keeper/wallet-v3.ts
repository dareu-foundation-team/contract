// Read-only V3 keeper wallet diagnostic. Starts and fully syncs the shielded,
...
import { connectKeeperV3 } from '../shared/chain-v3.js'
...
async function main(): Promise<void> {
  ...
  const ctx = await connectKeeperV3(network)
  try {
    ...
    console.log('Keeper V3 wallet diagnostic passed.')
